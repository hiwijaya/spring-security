...
public class TokenProvider {
    ...
    @Autowired
    private UserDetailsService userDetailsService;      // inject by AuthService
    ...
    public String createToken(String username, Role role) {
        ...
        claims.put("role", role.toString());    // optional


        final long TOKEN_VALIDITY = 3_600_000 * 24;   // 1day

        Date now = new Date();
        Date expiredDate = new Date(now.getTime() + TOKEN_VALIDITY);
